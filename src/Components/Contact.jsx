...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.name || !formData.email || !formData.message) {
      setAlert(t("contact.alert_error"));
      return;
    }

    setAlert(t("contact.alert_success"));
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@legacyit.com</p>
                    <p className="text-gray-600">support@legacyit.com</p>
                  </div>
                </div>
